...
from .models.bert.modeling_bert import BertSelfAttention, BertLayer
from .models.deberta.modeling_deberta import DisentangledSelfAttention, DebertaLayer
        ...
        for epoch in range(epochs_trained, num_train_epochs):
            ...
            for step, inputs in enumerate(epoch_iterator):
                ...
                if (
                    ...
                    with model.no_sync():
                        tr_loss_step = self.training_step(model, inputs, **kwargs)
                else:
                    tr_loss_step = self.training_step(model, inputs, **kwargs)
